...
class MiniklopediaAdapter(miniklopediaFragment: MiniklopediaFragment) : ListAdapter<DataItem, MiniklopediaAdapter.MyViewHolder>(
    DIFF_CALLBACK
) {
    ...
    class MyViewHolder(val binding: ItemBookmarksBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(review: DataItem){
            ...
            itemView.setOnClickListener {
                ...
                intent.putExtra("extra_status", "miniklopedia")
